...
class CatBreed extends StatefulWidget {
  final File _image;
  const CatBreed(
    this._image, {
    Key key,
  ...
  @override
  State<CatBreed> createState() => _CatBreedState();
}

class _CatBreedState extends State<CatBreed> {
  bool _loading = true;
  File _image;
  List _output;
  ...
  loadModel() async {
    await Tflite.loadModel(
        model: 'assets/images/Cat/model_unquant.tflite',
        labels: 'assets/images/Cat/labels.txt');
  }
