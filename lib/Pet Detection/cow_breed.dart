...
class CowBreed extends StatefulWidget {
  final File _image;
  const CowBreed(
    this._image, {
    Key key,
  ...
  @override
  State<CowBreed> createState() => _CowBreedState();
}

class _CowBreedState extends State<CowBreed> {
  bool _loading = true;
  File _image;
  List _output;
  ...
  loadModel() async {
    await Tflite.loadModel(
        model: 'assets/images/Cow/model_unquant.tflite',
        labels: 'assets/images/Cow/labels.txt');
  }
